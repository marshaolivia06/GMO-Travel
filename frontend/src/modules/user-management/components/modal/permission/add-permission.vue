    ...
    >
      ...
      <div class="px-6 pb-6 pt-7">
        ...
        <div class="mt-5 text-center">
          ...
          >
            Please review the permission details below before adding it.
          </p>
        </div>
        ...
        >
          ...
          <button
            type="button"
            class="inline-flex min-w-[120px] items-center justify-center gap-2 rounded-lg border-0 bg-green-600 px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-green-700 hover:shadow disabled:cursor-not-allowed disabled:opacity-60 max-[600px]:w-full"
            :disabled="loading"
            @click="handleSubmit"
          >
            <svg
            ...
            {{ loading ? 'Menyimpan...' : 'Yes, Add Permission' }}
          </button>
        </div>
      </div>
    </div>
